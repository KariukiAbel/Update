            ...
            if(mysqli_num_rows($result) > 0){
               while($row = mysqli_fetch_assoc($result)){
                   ...
                   if(password_verify($password, $password_verify)){
                        ...
                        // $type == 1 ? header("location:../dashboard/customer/indexs.php") : header("location:../dashboard/supplier/indexs.php");
                   }else{
...
<head>
    ...
    <script src="../public/css/main.css" rel="stylesheet"> </script>
</head>
        ...
        <div class="container-fluid">
            <div class="row mt-5">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" id="login-form" method="POST">
                    ...
                    <span class="offset-6"><a class="text-warning" href="#passModal" data-toggle="modal">Forgot Password?</a></span>
                </form>               
                </div>
            </div>
                                ...
                                case "status":
                                    if(response.status == "success"){
                                        ...
                                        window.setTimeout(function(){
                                            location.href = ((user_type == 1) ? "../dashboard/customer/customer.php" : "../dashboard/inventory")}, 500)                       
                                        }else{
