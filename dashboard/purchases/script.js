    ...
    $.ajax({
        ...
        success: function (data, status) {
            ...
            if (response.status == "success") {
                ...
                $("#error").html(`<div class="alert alert-danger">Error! Supplier KRA Pin does not exist</div>`)
    ...
    $.ajax({
        ...
        success: function (data, status) {
            ...
            if (response.status == "success") {
                ...
                $("#error").html(`<div class="alert alert-danger">Error! Product does not exist</div>`)
                $("#error").effect("bounce", {times:3}, 300 )
            }
        }
    });
        ...
        $.ajax({
            ...
            success: function(data, status){
                ...
                if(response.status == "success"){
                    ...
                    //show inserted data without reload
                    $('#table_result tr:last').before($(".mt-3"),'<tr>' +
                        '<td></td>' +
                        '<td>' + supplier_name +'</td>' +
                        '<td>'+ pin +'</td>' +
                        '<td>'+ location +'</td>' +
