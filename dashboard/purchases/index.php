                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 ml-auto"><input type="text" id="product_code" class="form-control" placeholder="Product Code"></div>
                            </div>
                    <div class="row">
                        ...
                        <div class="col-md-8 ml-auto"><input type="text" id="prod" class="form-control" placeholder="Product name"></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 ml-auto"><input type="text" id="receipt" class="form-control" placeholder="Product receipt number"></div>
                            </div>
                     <div class="row">
