...
<head>
    ...
    <style>
        thead tr:nth-child(1) th{background: white; position: sticky;top: 0;z-index: 10; width: 100%}
...
<body>
    ...
    <main>
        <div class="container-fluid">
                <div class="row mt-5 mr-auto ml-auto maintain">
            ...
            <p style="text-align: center; font-size: 20px; color: #0056b3"><strong>Inventory</strong></p>

            <div class="row m-auto maintain">
                ...
                <div class="col-md-12">
                    <table class="table table-striped table-responsive table-bordered m-auto">
                        ...
                        <tr>
                            ...
                            <th style="width: 5%">Availablity</th>
